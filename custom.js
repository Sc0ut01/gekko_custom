...
if (stevec_candle > 5) {
  ...
  rsi_povprecje = ((rsi_2 - rsi_1) + (rsi_3 - rsi_2) + (rsi_4 - rsi_3) + (rsi_5 - rsi_4) + (rsiVal - rsi_5))/5;
  ...
  if (test == 0 && check_ze == 0) {

    this.advice('long');
    //log.debug(stevec_candle-5,'kupil',rsi_povprecje,rsiVal - rsi_5,rsi_razmerje);
    log.debug(rsi_povprecje);
    test = 1;
    check_ze = 1;

  }

  if (test == 1 && check_ze == 0) {
    
      this.advice('short');
      //log.debug(stevec_candle-5,'prodal',rsi_povprecje,rsiVal - rsi_5,rsi_razmerje);
      log.debug(rsi_povprecje);
      test = 0;
      check_ze = 1;
